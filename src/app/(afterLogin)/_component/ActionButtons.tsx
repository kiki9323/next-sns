...
/**
 * cx 사용방법
 * 1. className={cx(style.commentButton, { [style.commented]: commented })} - dynamic property
 * 2. className={cx(style.repostButton, reposted && style.reposted)}
 * 3. className={cx([style.heartButton, liked && style.liked])}
 */
